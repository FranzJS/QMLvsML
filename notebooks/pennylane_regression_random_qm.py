...
for i in range(3):
    # create dataset from random quantum model
    n_samples = 500
    n_dim = 4
    n_layers = 2
    ...
    train_dataloader = DataLoader(train_data_list, batch_size=50, shuffle=True)
    ...
    torch.save(target_model.state_dict(), save_path+"target_model.pt")
    print("Done!")
